...
-- Views (No RLS directly applied to standard views in Postgres lacking security barrier without functions, 
-- but when queried via postgrest, underlying table RLS applies automatically).
